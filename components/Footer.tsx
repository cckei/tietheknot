...
const FOOTER_LINKS = [
  {
    ...
    items: [
      ...
      { text: 'Instagram(UK)', href: 'https://www.instagram.com/tietheknot.floral', external: true },
      { text: 'Instagram(Hong Kong)', href: 'https://www.instagram.com/tietheknot.florist', external: true },
    ],
  },
  {
    heading: 'Support',
